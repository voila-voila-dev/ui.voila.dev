...
function GroupLabel({ className, render, ...props }: SidebarGroupLabelProps) {
  return useRender({
    defaultTagName: "div",
...
function GroupAction({ className, render, ...props }: SidebarGroupActionProps) {
  return useRender({
...
function MenuAction({ className, render, showOnHover = false, ...props }: SidebarMenuActionProps) {
  return useRender({
    defaultTagName: "button",
    props: mergeProps<"button">(
      {
